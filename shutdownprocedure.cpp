...
int main(){
    ...
    if(ans[0] == 'Y' || ans[0] == 'y'){
        ...
        system("shutdown /h");
        system("cls");
        ascii_art("Welcome Back");
        cout << "\n\n\nInstantiating Startups...";
        Sleep(3000);
        system("start msedge https://www.messenger.com/t/100012335011359");
        system("start msedge https://www.youtube.com/playlist?list=PLkOYNZ8CXolDGPjyjhunUdsWjBFfsVQMU");
        system("code");
    }else{
        system("cls");
        cout << "\n\n\nUhm... okay... go back? Y/n: ";
        cin >> ans;
        if(ans[0] != 'n' && ans[0] != 'N'){
            system("cls");
            ascii_art("Welcome Back");
